...
export const DOMAIN_CORPUS: DomainSpec[] = [
...

  {
    ...
    sources: [
      ...
      { id: '87-712',           label: 'Décret 87-712 — Réparations locatives', legitext: 'LEGITEXT000006066148', fond: 'LODA_DATE' },
      { id: '2002-120',         label: 'Décret 2002-120 — Décence logement',    legitext: 'LEGITEXT000005632175', fond: 'LODA_DATE' },
    ],
...

  {
    ...
    sources: [
      ...
      { id: '2020-834',  label: 'Décret 2020-834 — Réforme copropriété', legitext: 'LEGITEXT000042076025', fond: 'LODA_DATE' },
    ],
...

  {
    ...
    sources: [
      ...
      { id: '2016-173',           label: 'Décret 2016-173 — Formation continue agents', legitext: 'JORFTEXT000032080616', fond: 'LODA_DATE' },
