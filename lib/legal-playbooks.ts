...
const PLAYBOOKS: LegalPlaybook[] = [
  {
    ...
    practicalOutcome: [
      "Une offre d'achat contresignée par le vendeur peut en principe engager les deux parties si elle réunit les conditions d'une rencontre des volontés (art. 1113 C. civ.).",
      "Cet engagement doit être systématiquement nuancé selon : le contenu exact du document signé, les conditions suspensives stipulées, et la nature du bien (habitation → droit de rétractation L271-1 CCH).",
      "Le délai de rétractation de 10 jours (L271-1 CCH) constitue la protection centrale de l'acquéreur non professionnel pour un bien à usage d'habitation.",
      "L'exécution forcée est théoriquement fondée sur l'art. 1589 C. civ. mais rarement accordée en pratique par les juges pour une simple offre.",
    ],
...

  {
    ...
    practicalOutcome: [
      "Un état des lieux de sortie incomplet fragilise fortement la position du bailleur qui souhaite retenir tout ou partie du dépôt de garantie, sans la rendre nécessairement impossible.",
      "L'agence mandataire doit alerter le bailleur par écrit de ce risque probatoire et documenter sa propre position (traçabilité de l'alerte).",
      "D'autres éléments de preuve peuvent théoriquement compléter un état des lieux lacunaire (photos datées, devis, attestations), mais leur recevabilité reste appréciée souverainement par le juge.",
      "En cas de litige, l'art. 1731 C. civ. présume que le locataire a reçu le logement en bon état — la charge de la preuve des dégradations pèse sur le bailleur.",
      "L'agence doit éviter tout engagement ferme sur la légalité ou l'illégalité d'une retenue sans avoir consulté le dossier complet.",
    ],
    confidenceStyle: 'guarded',
  },

  {
    ...
    practicalOutcome: [
      "La dénonciation d'un voisin peut conduire la commune ou le SPANC à diligenter un contrôle, mais ne constitue pas en elle-même une sanction ni une obligation de travaux immédiats.",
      "En cas de contrôle SPANC confirmant une non-conformité, les délais et obligations de mise en conformité dépendent de la gravité de l'atteinte sanitaire et de la politique locale.",
      "Les sanctions chiffrées ne doivent être mentionnées que si elles sont expressément couvertes par des sources taggées — éviter toute extrapolation.",
      "Actions pratiques prudentes : prendre contact avec le SPANC pour connaître sa position officielle, demander un rapport écrit, et consulter un professionnel avant tout engagement de travaux.",
    ],
